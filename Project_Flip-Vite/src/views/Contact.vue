        ...
        <div class="lg:flex">
            ...
            >
                <div class="xl:w-5/6 xl:px-0 px-8 mx-auto">
                    <h1 class="xl:text-4xl text-3xl pb-4 font-bold">
                        Get in touch
                    </h1>
                    <p class="text-xl pb-8 leading-relaxed font-normal lg:pr-4">
                        Got a question about us? Are you interested in
                        partnering with us? Have some suggestions or just want
                        to say Hi? Just contact us. We are here to asset you.
                    </p>
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="pl-4 text-base">
                            flippingindustries@gmail.com
                        </p>
                    </div>
                    <p class="text-lg pt-10 tracking-wide">
                        545, Street 11, Block F
                        <br />
                        Dean Boulevard, Ohio
                    </p>
                    <a href="javascript:void(0)">
                        <p class="pt-16 font-bold tracking-wide underline">
                            View Job Openings
                        </p>
                    </a>
                </div>
            ...
            >
                <form
                    id="contact"
                    class="bg-blue py-4 px-8 rounded-tr rounded-br"
                >
