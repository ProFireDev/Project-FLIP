...
<template>
    <div id="nav_bar" class="flex justify-around items-center text-gray" >
        ...
        <router-link id="nav_bar_Logo" to="/Home"> <img src="\src\assets\Trans_Home_Page_Logo.png" class="object-left h-48 w-22 scale-125 flex justify-start hover:underline decoration-orange mt-8"> </router-link> 
